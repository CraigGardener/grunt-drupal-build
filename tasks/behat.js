module.exports = function(grunt) {
  ...
  if (config.buildPaths.develop && config.siteUrls) {
        ...
        grunt.config(['behat', 'site-' + key],
          {
            ...
            options: _.extend({
              ...
              env: _.extend({}, process.env, {
                BEHAT_PARAMS: "{\"extensions\": {\"Drupal\\\\DrupalExtension\": {\"drupal\": {\"drupal_root\": \"./" + config.buildPaths.develop + "\"}}, \"Behat\\\\MinkExtension\": {\"base_url\": \"" + config.siteUrls[key] + "\", \"zombie\": {\"node_modules_path\": \"" + process.cwd() + "/node_modules/\"}}}}"
              })
            }, options)
          }
        );
